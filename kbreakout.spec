...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kbreakout-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kbreakout-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kbreakout-23.08.3
cd %{_builddir}/kbreakout-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699573323
mkdir -p clr-build
pushd clr-build
