...
Version  : 23.08.2
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.2/src/kbreakout-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kbreakout-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kbreakout-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kbreakout-23.08.2
cd %{_builddir}/kbreakout-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697256116
mkdir -p clr-build
pushd clr-build
