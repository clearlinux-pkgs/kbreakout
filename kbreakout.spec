...
Version  : 24.12.2
Release  : 78
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kbreakout-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kbreakout-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kbreakout-24.12.2.tar.xz.sig
...
%setup -q -n kbreakout-24.12.2
cd %{_builddir}/kbreakout-24.12.2
pushd ..
cp -a kbreakout-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738975983
mkdir -p clr-build
pushd clr-build
