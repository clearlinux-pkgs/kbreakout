...
Version  : 24.02.0
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kbreakout-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kbreakout-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kbreakout-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kbreakout-24.02.0
cd %{_builddir}/kbreakout-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709332178
mkdir -p clr-build
pushd clr-build
